...
if(points<=5){x.remainingFuel()}
if(points>5&&points<=8){console.log("well played")}
if(points==9){console.log("you won")}
else{console.log("keep trying")}
if(x.fuel==0){console.log("you lose...you got <=5 points four times");break}}}
